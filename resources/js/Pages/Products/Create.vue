...
const ObjSubtitle = ref([
    ...
    { message: "เพิ่มข้อมูลผลิตภัณฑ์ยา" },
]);
...
// const page = usePage().props.flash.old; 
                    ...
                    <div class="card-body">
                        <div class="row mb-1">
                            <div class="col-md-6 responsive-mobile-title">
                                <h4 class="header-title"> เพิ่มข้อมูลผลิตภัณฑ์ยา (Drug product information) </h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group"> 
                                                ...
                                                <Dropdown v-model="form.category_id" :options="categcts" filter optionLabel="category_name" placeholder="Select a Categcts" class="w-100" required>
